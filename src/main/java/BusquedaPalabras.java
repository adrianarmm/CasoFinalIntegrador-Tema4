...
public class BusquedaPalabras {
     ...
     *
     * @param   /Users/adrianareyesmorera/Documents/MENUSTARTASDEQUESO.txt El archivo en el que buscar la palabra.
    ...
    public static int countBusquedaPalabras(File file, String searchWord) throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            while ((line = reader.readLine()) != null) {
                ...
                String[] words = line.split("Tarta"); // "\\W+" es una expresión regular que representa uno o más caracteres no alfabéticos.
    ...
    public static void main(String[] args) {
        File file = new File("/Users/adrianareyesmorera/Documents/TARTASQUESO.txt");
